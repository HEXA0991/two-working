...
parser.add_argument('--model_write_ckpt',
                    default='./ckpts/micro_scierc', type=none_or_str,
                    action='store',)

parser.add_argument('--pretrained_wv',
                    default='./wv/glove.6B.100d.scierc.txt', type=none_or_str,
                    action='store',)
...
parser.add_argument('--ner_tag_vocab_size',
                    default=13, type=int,    # (label * BI + O) 9conll04
                    action='store',)

parser.add_argument('--re_tag_vocab_size',
                    default=15, type=int,    # ((label + Dep_To) * fw\bw + O) 11conll04
                    action='store',)
...
trainer = Trainer(
    model=model,
    train_path=f'./datasets/SCIERC/deprel_all/train.{flag}.deprel_all.json',
    test_path=f'./datasets/SCIERC/deprel_all/test.{flag}.deprel_all.json',
    valid_path=f'./datasets/SCIERC/deprel_all/valid.{flag}.deprel_all.json',
